...
export default function Cart() {
  ...
  const subtotal = cartItems.reduce(
    (sum, item) => sum + item.priceEach * item.qty,
    0
  );
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.body}>
        {cartItems.length === 0 ? (
          /* ── Empty State: takes all available space ── */
...
const styles = StyleSheet.create({
  ...
  // Body fills remaining space between header and bottom nav
  body: {
    flex: 1,
  },
